...
| **Max / Archival** | SVT-AV1 Max rung (CRF 38, preset 6) in MKV, hardware off | Archive-friendly files |
...
| **SVT-AV1** (archival, hardware off) | CRF 32, preset 10 | CRF 35, preset 8 | CRF 38, preset 6 — **Max / Archival** |
